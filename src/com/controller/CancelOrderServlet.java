...
public class CancelOrderServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("Inside CancelOrderServlet doPost() method");
		int cancelledOrderId=Integer.parseInt(request.getParameter("cancelProduct"));
		System.out.println("Cancelled order Id : "+cancelledOrderId);
		...
		if(session!=null){
			...
			mySqlDB.DeleteOrder(cancelledOrderId);
		}
		...
		TableHTML="<table>"+CustomerLinksHTML+ManagerLinksHTML+LoginUserHTML+"<tr><th style='color: red;background-color: white;border: 2px solid red;'>Order is Cancelled!</th></tr></table>";
